...
const App = () => {
  ...
  return (
    <div className="h-screen bg-black w-full p-5">
      ...
      <p className="text-white font-semibold mb-4 text-6xl">
        {num.isBanned.toString()}
      </p>
      <button
        onClick={() => setnum({ name: "dhruval", isBanned: !num.isBanned })}
        className={`px-4 py-2    ${
          val.isBanned ? "bg-blue-400" : "bg-red-300"
